<?php
/**
 * Script FINAL untuk membuat tabel Evaluasi Guru - PASTI BERHASIL
 * Akses: http://localhost/nurani/public/BUAT_TABEL_EVALUASI_FINAL.php
 */
...
try {
    ...
    if ($allSuccess) {
        header("Refresh: 2; url=http://localhost/nurani/public/guru/evaluasi/rubrik");
    }
    ...
    <div class="container">
        ...
        <p style="text-align: center; margin-top: 20px; color: #666;">
            <?php if(isset($allSuccess) && $allSuccess): ?>
                Mengarahkan ke halaman Rubrik Penilaian dalam 2 detik...
            <?php else: ?>
