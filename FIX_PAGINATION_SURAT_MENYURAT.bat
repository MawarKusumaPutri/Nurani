@echo off
title FIX PAGINATION SURAT MENYURAT
color 0A

echo.
echo ============================================
echo FIX PAGINATION SURAT MENYURAT
echo ============================================
echo.
...
echo [OK] Controller TuController::suratIndex() sudah diperbaiki
echo [OK] View tu/surat/index.blade.php sudah diperbaiki
...
echo.
echo CARA TEST:
echo 1. Buka: http://127.0.0.1:8000/tu/surat
