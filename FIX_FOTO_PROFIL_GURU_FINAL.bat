@echo off
echo ========================================
echo FIX FOTO PROFIL GURU - FINAL
echo ========================================
echo.
...
echo - Debug info di console browser
echo - Error handling yang lebih baik
echo.
echo File yang sudah diperbaiki:
echo - resources/views/guru/profile/index.blade.php
echo - resources/views/guru/profile/edit.blade.php
echo.
...
echo 5. Pastikan foto tersimpan di: storage/app/public/profiles/guru/
echo.
echo Troubleshooting:
echo - Jika foto masih tidak muncul, cek console browser (F12)
echo - Cek apakah path foto muncul di halaman (jika ada error)
echo - Pastikan folder storage/app/public/profiles/guru/ ada
echo - Pastikan symlink storage sudah dibuat: php artisan storage:link
echo - Jika error di console, cek apakah file benar-benar ada di storage
echo.
pause
