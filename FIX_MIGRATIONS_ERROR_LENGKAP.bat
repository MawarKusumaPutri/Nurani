@echo off
echo ========================================
echo   FIX MIGRATIONS ERROR - LENGKAP
echo ========================================
echo.
...
echo 4. Start MySQL (WAJIB dilakukan manual di XAMPP)
...
php -r "try { $pdo = new PDO('mysql:host=127.0.0.1;port=3306', 'root', ''); $pdo->exec('DROP DATABASE IF EXISTS nurani'); $pdo->exec('CREATE DATABASE nurani CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci'); echo 'SUKSES: Database sudah dibuat!\n'; } catch(Exception $e) { echo 'ERROR: ' . $e->getMessage() . '\n'; exit(1); }"
