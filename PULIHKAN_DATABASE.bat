...
echo   4. Jalankan migrations (membuat tabel)
...
echo.
echo [INFO] Memulihkan database...
echo.

php pulihkan_database.php

if %errorlevel% equ 0 (
    echo.
    echo ========================================
    echo   BERHASIL DIPULIHKAN!
    echo ========================================
    echo.
    ...
    echo ========================================
    echo.
    echo [ERROR] Ada error selama proses pemulihan
