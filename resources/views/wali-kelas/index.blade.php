@if($role === 'tu')
    @extends('layouts.tu')
    @section('title', 'Wali Kelas - TU Dashboard')
    @section('content')
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ route('tu.wali-kelas.rencana') }}" class="btn btn-primary">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ route('tu.wali-kelas.monitoring') }}" class="btn btn-success">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ route('tu.wali-kelas.laporan') }}" class="btn btn-info">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
...
@elseif($role === 'guru')
    ...
    @section('title', 'Wali Kelas - Guru Dashboard')
    @section('content')
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <h4 class="card-title">Rencana Kegiatan</h4>
                                <p class="card-text text-muted">Buat dan kelola rencana kegiatan wali kelas</p>
                                <a href="{{ route('guru.wali-kelas.rencana') }}" class="btn btn-primary">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <h4 class="card-title">Monitoring Pelaksanaan</h4>
                                <p class="card-text text-muted">Pantau pelaksanaan kegiatan wali kelas</p>
                                <a href="{{ route('guru.wali-kelas.monitoring') }}" class="btn btn-success">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <h4 class="card-title">Laporan Kegiatan</h4>
                                <p class="card-text text-muted">Lihat dan kelola laporan hasil kegiatan</p>
                                <a href="{{ route('guru.wali-kelas.laporan') }}" class="btn btn-info">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
