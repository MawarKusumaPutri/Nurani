...
@if($layout)
    @extends($layout)
    @section('title', 'Wali Kelas - ' . ucfirst($role) . ' Dashboard')
    @section('content')
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ $role === 'tu' ? route('tu.wali-kelas.rencana') : ($role === 'guru' ? route('guru.wali-kelas.rencana') : route('kepala_sekolah.wali-kelas.rencana')) }}" class="btn btn-primary">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ $role === 'tu' ? route('tu.wali-kelas.monitoring') : ($role === 'guru' ? route('guru.wali-kelas.monitoring') : route('kepala_sekolah.wali-kelas.monitoring')) }}" class="btn btn-success">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ $role === 'tu' ? route('tu.wali-kelas.laporan') : ($role === 'guru' ? route('guru.wali-kelas.laporan') : route('kepala_sekolah.wali-kelas.laporan')) }}" class="btn btn-info">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
...
@else
    ...
    <head>
        ...
        <title>Wali Kelas - Kepala Sekolah Dashboard</title>
                        ...
                        <div class="col-md-4">
                            <div class="card shadow-sm h-100">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h4 class="card-title">Rencana Kegiatan</h4>
                                    <p class="card-text text-muted">Buat dan kelola rencana kegiatan wali kelas</p>
                                    <a href="{{ route('kepala_sekolah.wali-kelas.rencana') }}" class="btn btn-primary">
                                        <i class="fas fa-arrow-right me-2"></i>Masuk
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card shadow-sm h-100">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h4 class="card-title">Monitoring Pelaksanaan</h4>
                                    <p class="card-text text-muted">Pantau pelaksanaan kegiatan wali kelas</p>
                                    <a href="{{ route('kepala_sekolah.wali-kelas.monitoring') }}" class="btn btn-success">
                                        <i class="fas fa-arrow-right me-2"></i>Masuk
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card shadow-sm h-100">
                                <div class="card-body text-center p-4">
                                    ...
                                    <h4 class="card-title">Laporan Kegiatan</h4>
                                    <p class="card-text text-muted">Lihat dan kelola laporan hasil kegiatan</p>
                                    <a href="{{ route('kepala_sekolah.wali-kelas.laporan') }}" class="btn btn-info">
                                        <i class="fas fa-arrow-right me-2"></i>Masuk
                                    </a>
                                </div>
                            </div>
