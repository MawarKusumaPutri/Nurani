@if($role === 'tu')
    @extends('layouts.tu')
    @section('title', 'Kegiatan Kesiswaan - TU Dashboard')
    @section('content')
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ route('tu.kegiatan-kesiswaan.rencana') }}" class="btn btn-primary">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ route('tu.kegiatan-kesiswaan.monitoring') }}" class="btn btn-success">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ route('tu.kegiatan-kesiswaan.laporan') }}" class="btn btn-info">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
...
@elseif($role === 'guru')
    ...
    @section('title', 'Kegiatan Kesiswaan - Guru Dashboard')
    @section('content')
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <h4 class="card-title">Rencana Kegiatan</h4>
                                <p class="card-text text-muted">Buat dan kelola rencana kegiatan kesiswaan</p>
                                <a href="{{ route('guru.kegiatan-kesiswaan.rencana') }}" class="btn btn-primary">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <h4 class="card-title">Monitoring Pelaksanaan</h4>
                                <p class="card-text text-muted">Pantau pelaksanaan kegiatan kesiswaan</p>
                                <a href="{{ route('guru.kegiatan-kesiswaan.monitoring') }}" class="btn btn-success">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <h4 class="card-title">Laporan Kegiatan</h4>
                                <p class="card-text text-muted">Lihat dan kelola laporan hasil kegiatan</p>
                                <a href="{{ route('guru.kegiatan-kesiswaan.laporan') }}" class="btn btn-info">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
