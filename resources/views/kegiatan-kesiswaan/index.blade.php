...
<head>
    ...
    <title>Kegiatan Kesiswaan - TMS NURANI</title>
            ...
            <div class="col-md-4">
                <div class="card feature-card shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <a href="{{ $role === 'guru' ? route('guru.kegiatan-kesiswaan.rencana') : ($role === 'kepala_sekolah' ? route('kepala_sekolah.kegiatan-kesiswaan.rencana') : route('tu.kegiatan-kesiswaan.rencana')) }}" class="btn btn-primary">
            ...
            <div class="col-md-4">
                <div class="card feature-card shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <a href="{{ $role === 'guru' ? route('guru.kegiatan-kesiswaan.monitoring') : ($role === 'kepala_sekolah' ? route('kepala_sekolah.kegiatan-kesiswaan.monitoring') : route('tu.kegiatan-kesiswaan.monitoring')) }}" class="btn btn-success">
                            <i class="fas fa-arrow-right me-2"></i>Masuk
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card feature-card shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <a href="{{ $role === 'guru' ? route('guru.kegiatan-kesiswaan.laporan') : ($role === 'kepala_sekolah' ? route('kepala_sekolah.kegiatan-kesiswaan.laporan') : route('tu.kegiatan-kesiswaan.laporan')) }}" class="btn btn-info">
                            <i class="fas fa-arrow-right me-2"></i>Masuk
                        </a>
                    </div>
                </div>
