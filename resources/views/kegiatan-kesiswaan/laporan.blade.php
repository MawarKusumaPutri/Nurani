@if($role === 'tu')
    @extends('layouts.tu')
    @section('title', 'Laporan Kegiatan Kesiswaan - TU Dashboard')
    @section('content')
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="alert alert-info">
                    ...
                    Ruang untuk melihat dan mengelola laporan hasil kegiatan kesiswaan. Fitur ini akan dikembangkan lebih lanjut.
                </div>
            </main>
        </div>
    </div>
...
@elseif($role === 'guru')
    ...
    @section('title', 'Laporan Kegiatan Kesiswaan - Guru Dashboard')
    @section('content')
    <div class="container-fluid">
        <div class="row">
