@if($role === 'tu')
    @extends('layouts.tu')
    @section('title', 'Monitoring Kegiatan Kesiswaan - TU Dashboard')
    @section('content')
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">
                        <i class="fas fa-chart-line me-2"></i>Monitoring Pelaksanaan Kegiatan Kesiswaan
                    </h1>
                </div>
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>
                    Ruang untuk monitoring pelaksanaan kegiatan kesiswaan. Fitur ini akan dikembangkan lebih lanjut.
                </div>
            </main>
        </div>
    </div>
...
@elseif($role === 'guru')
    ...
    @section('title', 'Monitoring Kegiatan Kesiswaan - Guru Dashboard')
    @section('content')
    <div class="container-fluid">
        <div class="row">
