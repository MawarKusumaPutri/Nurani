...
<head>
    ...
    <title>Kurikulum - TMS NURANI</title>
            ...
            <div class="col-md-4">
                <div class="card feature-card shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <a href="{{ $role === 'guru' ? route('guru.kurikulum.rencana') : ($role === 'kepala_sekolah' ? route('kepala_sekolah.kurikulum.rencana') : route('tu.kurikulum.rencana')) }}" class="btn btn-primary">
            ...
            <div class="col-md-4">
                <div class="card feature-card shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <a href="{{ $role === 'guru' ? route('guru.kurikulum.monitoring') : ($role === 'kepala_sekolah' ? route('kepala_sekolah.kurikulum.monitoring') : route('tu.kurikulum.monitoring')) }}" class="btn btn-success">
                            <i class="fas fa-arrow-right me-2"></i>Masuk
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card feature-card shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <a href="{{ $role === 'guru' ? route('guru.kurikulum.laporan') : ($role === 'kepala_sekolah' ? route('kepala_sekolah.kurikulum.laporan') : route('tu.kurikulum.laporan')) }}" class="btn btn-info">
                            <i class="fas fa-arrow-right me-2"></i>Masuk
                        </a>
                    </div>
                </div>
