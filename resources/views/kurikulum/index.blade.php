...
@if($layout)
    @extends($layout)
    @section('title', 'Kurikulum - ' . ucfirst($role) . ' Dashboard')
    @section('content')
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ $role === 'tu' ? route('tu.kurikulum.rencana') : ($role === 'guru' ? route('guru.kurikulum.rencana') : route('kepala_sekolah.kurikulum.rencana')) }}" class="btn btn-primary">
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ $role === 'tu' ? route('tu.kurikulum.monitoring') : ($role === 'guru' ? route('guru.kurikulum.monitoring') : route('kepala_sekolah.kurikulum.monitoring')) }}" class="btn btn-success">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ $role === 'tu' ? route('tu.kurikulum.laporan') : ($role === 'guru' ? route('guru.kurikulum.laporan') : route('kepala_sekolah.kurikulum.laporan')) }}" class="btn btn-info">
                                    <i class="fas fa-arrow-right me-2"></i>Masuk
                                </a>
                            </div>
                        </div>
