@if($role === 'tu')
    @extends('layouts.tu')
    @section('title', 'Laporan Kurikulum - TU Dashboard')
    @section('content')
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">
                        <i class="fas fa-file-alt me-2"></i>Laporan Kegiatan Kurikulum
                    </h1>
                </div>
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>
                    Ruang untuk melihat dan mengelola laporan hasil kegiatan kurikulum. Fitur ini akan dikembangkan lebih lanjut.
                </div>
            </main>
        </div>
    </div>
...
@elseif($role === 'guru')
    ...
    @section('title', 'Laporan Kurikulum - Guru Dashboard')
    @section('content')
    <div class="container-fluid">
        <div class="row">
...
@else
    ...
    <head>
        ...
        <title>Laporan Kurikulum - Kepala Sekolah Dashboard</title>
