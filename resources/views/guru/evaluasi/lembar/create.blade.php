...
<head>
    ...
    <title>Tambah Lembar Penilaian - {{ $guru->user->name }}</title>
            ...
            <div class="col-md-9 col-lg-10 p-4" style="background-color: #ffffff !important; background: #ffffff !important;">
                ...
                <div class="mb-4">
                    <h2 class="mb-2">
                        ...
                        Tambah Lembar Penilaian
                    </h2>
                    <p class="text-muted mb-3">Buat lembar penilaian baru untuk siswa</p>
                ...
                <div class="row">
                    <div class="col-md-10 col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('guru.evaluasi.lembar.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_penilaian" name="tanggal_penilaian" required value="{{ date('Y-m-d') }}">
                                        </div>
                                    </div>
                                            ...
                                            @if($rubrikList->count() > 0)
                                                <optgroup label="Rubrik Penilaian">
                                                    @foreach($rubrikList as $rubrik)
                                                        <option value="{{ $rubrik->id }}">{{ $rubrik->judul }}</option>
                                                    @endforeach
                                                </optgroup>
                                            @endif
                                            @if($kuisList->count() > 0)
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" min="0" max="100" class="form-control" id="nilai" name="nilai" placeholder="0.00 - 100.00">
                                    </div>

                                    <div class="mb-3">
                                        <label for="aspek_penilaian" class="form-label">Aspek Penilaian</label>
                                        <textarea class="form-control" id="aspek_penilaian" name="aspek_penilaian" rows="3" placeholder="Masukkan aspek penilaian"></textarea>
                                    </div>

                                    <div class="mb-3">
                                        <label for="catatan" class="form-label">Catatan</label>
                                        <textarea class="form-control" id="catatan" name="catatan" rows="3" placeholder="Masukkan catatan penilaian"></textarea>
                                    </div>
