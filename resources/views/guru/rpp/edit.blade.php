...
<head>
    ...
    <title>Edit RPP - {{ $rpp->judul }}</title>
            ...
            <div class="col-md-9 col-lg-10 p-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Edit Rencana Pelaksanaan Pembelajaran</p>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('guru.rpp.update', $rpp->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="sekolah" name="sekolah" 
                                           value="{{ old('sekolah', $rpp->sekolah ?? 'Mts Nurul Aiman') }}" readonly style="background-color: #e9ecef;">
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('kelas') is-invalid @enderror" id="kelas" name="kelas" required>
                                        ...
                                        <option value="VII" {{ old('kelas', $rpp->kelas) == 'VII' ? 'selected' : '' }}>Kelas 7</option>
                                        <option value="VIII" {{ old('kelas', $rpp->kelas) == 'VIII' ? 'selected' : '' }}>Kelas 8</option>
                                        <option value="IX" {{ old('kelas', $rpp->kelas) == 'IX' ? 'selected' : '' }}>Kelas 9</option>
                                    </select>
                                    @error('kelas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select @error('semester') is-invalid @enderror" id="semester" name="semester" required>
                                        ...
                                        <option value="Ganjil" {{ old('semester', $rpp->semester) == 'Ganjil' ? 'selected' : '' }}>Ganjil</option>
                                        <option value="Genap" {{ old('semester', $rpp->semester) == 'Genap' ? 'selected' : '' }}>Genap</option>
                                    </select>
                                    @error('semester')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('pertemuan_ke') is-invalid @enderror" 
                                           ...
                                           value="{{ old('pertemuan_ke', $rpp->pertemuan_ke) }}" 
                                           min="1" required readonly style="background-color: #e9ecef;">
                                    @error('pertemuan_ke')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control @error('alokasi_waktu') is-invalid @enderror" 
                                           ...
                                           value="{{ old('alokasi_waktu', $rpp->alokasi_waktu) }}" 
                                           min="1" required>
                                    @error('alokasi_waktu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tahun_pelajaran" name="tahun_pelajaran" 
                                           value="{{ old('tahun_pelajaran', $rpp->tahun_pelajaran ?? '2025-2026') }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="ki_1" name="ki_1" rows="2" 
                                          placeholder="Menghargai dan menghayati ajaran agama yang dianutnya">{{ old('ki_1', $rpp->ki_1) }}</textarea>
                            </div>
                            
                            <div class="mb-3">
                                <label for="ki_2" class="form-label fw-bold">KI-2: Sikap Sosial</label>
                                <textarea class="form-control" id="ki_2" name="ki_2" rows="2" 
                                          placeholder="Menghargai dan menghayati perilaku jujur, disiplin, tanggung jawab...">{{ old('ki_2', $rpp->ki_2) }}</textarea>
                            </div>
                            
                            <div class="mb-3">
                                <label for="ki_3" class="form-label fw-bold">KI-3: Pengetahuan</label>
                                <textarea class="form-control" id="ki_3" name="ki_3" rows="2" 
                                          placeholder="Memahami pengetahuan (faktual, konseptual, dan prosedural)...">{{ old('ki_3', $rpp->ki_3) }}</textarea>
                            </div>
                            
                            <div class="mb-3">
                                <label for="ki_4" class="form-label fw-bold">KI-4: Keterampilan</label>
                                <textarea class="form-control" id="ki_4" name="ki_4" rows="2" 
                                          placeholder="Mencoba, mengolah, dan menyaji dalam ranah konkret dan ranah abstrak...">{{ old('ki_4', $rpp->ki_4) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="kd_pengetahuan" name="kd_pengetahuan" rows="3" 
                                          placeholder="Masukkan Kompetensi Dasar Pengetahuan...">{{ old('kd_pengetahuan', $rpp->kd_pengetahuan) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="kd_keterampilan" name="kd_keterampilan" rows="3" 
                                          placeholder="Masukkan Kompetensi Dasar Keterampilan...">{{ old('kd_keterampilan', $rpp->kd_keterampilan) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="indikator_pencapaian_kompetensi" name="indikator_pencapaian_kompetensi" rows="4" 
                                          placeholder="Masukkan indikator pencapaian kompetensi...">{{ old('indikator_pencapaian_kompetensi', $rpp->indikator_pencapaian_kompetensi) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="tujuan_pembelajaran" name="tujuan_pembelajaran" rows="5" 
                                          placeholder="Masukkan tujuan pembelajaran yang ingin dicapai...">{{ old('tujuan_pembelajaran', $rpp->tujuan_pembelajaran) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="materi_pembelajaran" name="materi_pembelajaran" rows="5" 
                                          placeholder="Masukkan materi pembelajaran...">{{ old('materi_pembelajaran', $rpp->materi_pembelajaran) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="metode_pembelajaran" name="metode_pembelajaran" rows="3" 
                                          placeholder="Contoh: Ceramah, Diskusi, Tanya Jawab, Penugasan...">{{ old('metode_pembelajaran', $rpp->metode_pembelajaran) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="kegiatan_pendahuluan" name="kegiatan_pendahuluan" rows="4" 
                                          placeholder="Masukkan kegiatan pendahuluan (pembukaan, apersepsi, motivasi)...">{{ old('kegiatan_pendahuluan', $rpp->kegiatan_pendahuluan) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="kegiatan_inti" name="kegiatan_inti" rows="6" 
                                          placeholder="Masukkan kegiatan inti pembelajaran (mengamati, menanya, mengumpulkan informasi, mengasosiasi, mengkomunikasikan)...">{{ old('kegiatan_inti', $rpp->kegiatan_inti) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="kegiatan_penutup" name="kegiatan_penutup" rows="4" 
                                          placeholder="Masukkan kegiatan penutup (kesimpulan, refleksi, evaluasi)...">{{ old('kegiatan_penutup', $rpp->kegiatan_penutup) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="media_pembelajaran" name="media_pembelajaran" rows="3" 
                                          placeholder="Contoh: Papan tulis, LCD Proyektor, Video, PPT...">{{ old('media_pembelajaran', $rpp->media_pembelajaran) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="sumber_belajar" name="sumber_belajar" rows="3" 
                                          placeholder="Contoh: Buku paket, modul, internet, dll...">{{ old('sumber_belajar', $rpp->sumber_belajar) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="teknik_penilaian" name="teknik_penilaian" rows="3" 
                                          placeholder="Contoh: Tes tertulis, observasi, penugasan...">{{ old('teknik_penilaian', $rpp->teknik_penilaian) }}</textarea>
                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="border rounded p-3 text-center bg-light" id="preview_ttd_kepsek" style="min-height: 150px;">
                                        @if($rpp->ttd_kepala_sekolah)
                                            ...
                                            <p class="text-success mb-0 small mt-2">
                                                ...
                                                Tanda tangan sudah ada (upload baru untuk mengganti)
                                            </p>
                                        @else
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p class="mb-2 text-muted">{{ $rpp->mata_pelajaran }}</p>
