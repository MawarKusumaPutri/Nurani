...
<head>
    ...
    <title>Tambah RPP - {{ $guru->user->name }}</title>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="pertemuan_ke" name="pertemuan_ke" value="{{ old('pertemuan_ke') }}" min="1" required>
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label for="alokasi_waktu" class="form-label">Alokasi Waktu (menit) <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" id="alokasi_waktu" name="alokasi_waktu" value="{{ old('alokasi_waktu') }}" min="1" required>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="accordion-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="sekolah" name="sekolah" value="{{ old('sekolah', 'MTs Nurul Aiman') }}">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="mata_pelajaran_detail" class="form-label">Mata Pelajaran (Detail)</label>
                                            <input type="text" class="form-control" id="mata_pelajaran_detail" name="mata_pelajaran_detail" value="{{ old('mata_pelajaran_detail') }}">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="kelas_detail" class="form-label">Kelas (Detail)</label>
                                            <input type="text" class="form-control" id="kelas_detail" name="kelas_detail" value="{{ old('kelas_detail') }}">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="semester_detail" class="form-label">Semester (Detail)</label>
                                            <input type="text" class="form-control" id="semester_detail" name="semester_detail" value="{{ old('semester_detail') }}">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="tahun_pelajaran" class="form-label">Tahun Pelajaran</label>
                                            <input type="text" class="form-control" id="tahun_pelajaran" name="tahun_pelajaran" value="{{ old('tahun_pelajaran', date('Y') . '/' . (date('Y') + 1)) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="collapse2" class="accordion-collapse collapse" data-bs-parent="#rppAccordion">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="ki_1" name="ki_1" rows="3">{{ old('ki_1') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="ki_2" class="form-label">KI-2 (Sikap Sosial)</label>
                                        <textarea class="form-control" id="ki_2" name="ki_2" rows="3">{{ old('ki_2') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="ki_3" class="form-label">KI-3 (Pengetahuan)</label>
                                        <textarea class="form-control" id="ki_3" name="ki_3" rows="3">{{ old('ki_3') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="ki_4" class="form-label">KI-4 (Keterampilan)</label>
                                        <textarea class="form-control" id="ki_4" name="ki_4" rows="3">{{ old('ki_4') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapse3" class="accordion-collapse collapse" data-bs-parent="#rppAccordion">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="kd_pengetahuan" name="kd_pengetahuan" rows="3">{{ old('kd_pengetahuan') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="kd_keterampilan" class="form-label">KD Keterampilan</label>
                                        <textarea class="form-control" id="kd_keterampilan" name="kd_keterampilan" rows="3">{{ old('kd_keterampilan') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="indikator_pencapaian_kompetensi" class="form-label">Indikator Pencapaian Kompetensi</label>
                                        <textarea class="form-control" id="indikator_pencapaian_kompetensi" name="indikator_pencapaian_kompetensi" rows="4">{{ old('indikator_pencapaian_kompetensi') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapse4" class="accordion-collapse collapse" data-bs-parent="#rppAccordion">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="tujuan_pembelajaran" name="tujuan_pembelajaran" rows="5">{{ old('tujuan_pembelajaran') }}</textarea>
                            ...
                            <div id="collapse5" class="accordion-collapse collapse" data-bs-parent="#rppAccordion">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="materi_pembelajaran" name="materi_pembelajaran" rows="4">{{ old('materi_pembelajaran') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="materi_pembelajaran_reguler" class="form-label">Materi Pembelajaran Reguler</label>
                                        <textarea class="form-control" id="materi_pembelajaran_reguler" name="materi_pembelajaran_reguler" rows="3">{{ old('materi_pembelajaran_reguler') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="materi_pembelajaran_pengayaan" class="form-label">Materi Pembelajaran Pengayaan</label>
                                        <textarea class="form-control" id="materi_pembelajaran_pengayaan" name="materi_pembelajaran_pengayaan" rows="3">{{ old('materi_pembelajaran_pengayaan') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="materi_pembelajaran_remedial" class="form-label">Materi Pembelajaran Remedial</label>
                                        <textarea class="form-control" id="materi_pembelajaran_remedial" name="materi_pembelajaran_remedial" rows="3">{{ old('materi_pembelajaran_remedial') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapse6" class="accordion-collapse collapse" data-bs-parent="#rppAccordion">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="metode_pembelajaran" name="metode_pembelajaran" rows="4">{{ old('metode_pembelajaran') }}</textarea>
                            ...
                            <div id="collapse7" class="accordion-collapse collapse" data-bs-parent="#rppAccordion">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="kegiatan_pendahuluan" name="kegiatan_pendahuluan" rows="4">{{ old('kegiatan_pendahuluan') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="kegiatan_inti" class="form-label">Kegiatan Inti</label>
                                        <textarea class="form-control" id="kegiatan_inti" name="kegiatan_inti" rows="6">{{ old('kegiatan_inti') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="kegiatan_penutup" class="form-label">Kegiatan Penutup</label>
                                        <textarea class="form-control" id="kegiatan_penutup" name="kegiatan_penutup" rows="4">{{ old('kegiatan_penutup') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="collapse8" class="accordion-collapse collapse" data-bs-parent="#rppAccordion">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="media_pembelajaran" name="media_pembelajaran" rows="4">{{ old('media_pembelajaran') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="sumber_belajar" name="sumber_belajar" rows="4">{{ old('sumber_belajar') }}</textarea>
                            ...
                            <div id="collapse9" class="accordion-collapse collapse" data-bs-parent="#rppAccordion">
                                <div class="accordion-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="teknik_penilaian" name="teknik_penilaian" rows="3">{{ old('teknik_penilaian') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="bentuk_instrumen" name="bentuk_instrumen" rows="3">{{ old('bentuk_instrumen') }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="rubrik_penilaian" name="rubrik_penilaian" rows="4">{{ old('rubrik_penilaian') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="kriteria_ketuntasan" class="form-label">Kriteria Ketuntasan</label>
                                        <textarea class="form-control" id="kriteria_ketuntasan" name="kriteria_ketuntasan" rows="3">{{ old('kriteria_ketuntasan') }}</textarea>
