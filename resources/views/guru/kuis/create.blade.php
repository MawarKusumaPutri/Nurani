                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('tipe_kuis') is-invalid @enderror" 
                                            ...
                                            <option value="video" {{ old('tipe_kuis') == 'video' ? 'selected' : '' }}>Video YouTube</option>
                                        </select>
                                        @error('tipe_kuis')
                                            <div class="text-danger small">{{ $message }}</div>
                                        @enderror
                            ...
                            <div id="video-fields" style="display: none;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('video_soal') is-invalid @enderror" 
                                              ...
                                              placeholder="Buat pertanyaan berdasarkan video yang akan ditonton siswa...">{{ old('video_soal') }}</textarea>
