...
<head>
    ...
    <style>
        ...
        @media (max-width: 991px) {
            ...
            /* Card profile aktivitas simetris */
            .profile-row-aktivitas {
                margin-left: 60px !important;
                margin-right: 15px !important;
                padding-left: 15px !important;
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-4">
                <!-- Header -->
                <div class="d-flex justify-content-between align-items-center mb-4 header-aktivitas">
                    <div class="header-title-section flex-grow-1">
                        ...
                        <p class="text-muted small mb-0">Pantau aktivitas pembelajaran{{ isset($guru) ? ' ' . $guru->user->name : ' Semua Guru' }}</p>
                    </div>
                ...
                <!-- Guru Profile -->
                <div class="row mb-4 profile-row-aktivitas">
                    <div class="col-12">
